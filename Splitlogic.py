...
def SplitFileWithZFEC(owner, user_id, filename, size, file_hash, n, k, output_folder="shards", progress_callback=None, owner_enc_session_key=None):
    ...
    return {'file_id': file_id, 'original_file': original_filename, 'public_key': pubkey_bytes.hex(),
            ...
            'total_fragments': n, 'required_fragments': k}
